...
<div className="text-center mb-16 text-white ">
  ...
  // }} 
  className="text-5xl  md:text-6xl lg:text-7xl xl:text-8xl font-abc-heavy-3  bold-stroke-3  leading-7 sm:leading-8 md:leading-10 lg:leading-14 xl:leading-16 tracking-[1px] mb-0">
    OLIM PASS
  </h1>

  <h2 className="text-3xl md:text-5xl lg:text-[65px] xl:text-[80px] font-abc-regular leading-8 sm:leading-10 md:leading-12 lg:leading-16 xl:leading-18 tracking-[-0.07em] mt-1">
